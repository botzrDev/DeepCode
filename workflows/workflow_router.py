...
class WorkflowRouter:
    ...
    def __init__(self, logger: logging.Logger = None):
        ...
        self.deepcode_indicators = [
            ...
            'analysis', 'implementation', 'reproduction', 'codebase',
        ...
        self.zenalto_indicators = [
            ...
            'content creation', 'social content', 'campaign', 'marketing',
            'audience', 'brand', 'viral', 'influencer', 'share'
        ]
        
        # File extensions associated with DeepCode workflows
        self.deepcode_file_types = [
            '.pdf', '.tex', '.py', '.js', '.md', '.txt', '.html',
            '.cpp', '.java', '.c', '.h', '.hpp', '.cs', '.go',
            '.ipynb', '.rst', '.docx', '.doc'
        ]
        ...
        self.zenalto_file_types = [
            ...
            '.csv', '.xlsx', '.json'  # For analytics data
        ]
    ...
    async def detect_workflow_type(self, input_data: Dict[str, Any]) -> str:
        ...
        try:
            ...
            self.logger.info(f"Analyzing workflow type for request: {user_request[:100]}...")
            ...
            self.logger.info(f"Workflow scores - DeepCode: {total_deepcode_score}, ZENALTO: {total_zenalto_score}")
    ...
    def _analyze_platform_context(self, platform_context: Dict[str, Any]) -> int:
        ...
        connected_platforms = sum(
            1 for status in platform_context.values() 
    ...
    def validate_workflow_input(self, workflow_type: str, input_data: Dict[str, Any]) -> Dict[str, Any]:
        """
